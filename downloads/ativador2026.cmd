@echo off
title Suporte Pos-Formatacao - NG Master v5.3
color 0F
...
:: ---INICIO_PS1---
<#
    Versao: 5.3 - Criado por Marcos
    Data: 25/03/2026

    Novidades da Versao 5.3:
    ...
    - NOVO: Envio de relatorio resumido via Discord Webhook (dispara antes da Ativacao, ou no fim).
...
function Get-SystemReport {
    ...
    $report = "====================================================`r`n" +
              ...
              "  Data/Hora   : $now`r`n" +
              "----------------------------------------------------`r`n" +
              "  Computador  : $hostname`r`n" +
              "  IP Local    : $ip`r`n" +
              "  Windows     : $winVer`r`n" +
              "  Edicao      : $edition`r`n" +
              "  Ativacao    : $activationStatus`r`n" +
              "----------------------------------------------------`r`n" +
              "  CPU         : $cpu`r`n" +
              "  RAM Total   : $ramGB GB`r`n" +
              "  Disco C:    : $usedGB GB usados / $freeGB GB livres / $totalGB GB total`r`n" +
              "===================================================="
...
function Show-InstallerGUI {
    ...
    $startButton.Add_Click({
        ...
        if ($chkSaveLog.Checked) {
            ...
            $header = "====================================================`r`n" +
                      "  LOG DE EXECUCAO - Script Pos-Formatacao v5.3`r`n" +
                      "====================================================`r`n" +
                      "  Tecnico   : $technicianName`r`n" +
